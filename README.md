...
![](Asset/scai-3.png)
- Read more for detailed instruction in [Grove Vision AI Module V2<br>
 Documentation](https://wiki.seeedstudio.com/grove_vision_ai_v2a/)<br><br>
### Flash SSCMA Viewer
...
- Connect Grove Vision AI Module V2 to M5Stick C using Grove Cable.<br>
[![](Asset/M5Cardputer-viewer.png)](https://www.youtube.com/shorts/j_-7xob3L08)<br><br>
#### M5Stick C Plus
...
- Connect Grove Vision AI Module V2 to M5Stick C using Grove Cable.<br>
[![](Asset/M5StickC-viewer.png)](https://www.youtube.com/shorts/MH8bTXh2OKM)<br><br>
...
- Connect Grove Vision AI Module V2 to CYD using custom Grove Cable with Grove connector in one-side and 4P 1.25 mm JST connector in other-side.<br>
